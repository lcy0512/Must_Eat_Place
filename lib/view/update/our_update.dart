...
class OurUpdate extends StatefulWidget {
  const OurUpdate({super.key});

  @override
  State<OurUpdate> createState() => _OurUpdateState();
}

class _OurUpdateState extends State<OurUpdate> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: SizedBox(
                      ...
                      ? Image.network('http://localhost:8080/Flutter/MustEatPlace/image/${argument['image']}')
